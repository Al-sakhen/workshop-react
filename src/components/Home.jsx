  ...
  return (
    <div class="container text-center my-5">
      ...
      <div class="buttons d-flex justify-content-center align-items-center  flex-column">
          <Link to="login" class="btn btn-default-outline my-4"><i class="fas fa-user"></i> Login</Link>
          <Link to="register" class="btn btn-default-outline"><i class="far fa-edit"></i> Register</Link>
      </div>
  </div>
  )
}
